...
class Vector:
    ...
    def __add__(self, other: "Vector") -> "Vector":
        return Vector(self.x_coordinate
                      + other.x_coordinate, self.y_coordinate
                      + other.y_coordinate)
    ...
    def __mul__(self, other: "Vector") -> "Vector":
        if isinstance(other, (int, float)):
            ...
            return round(self.x_coordinate
                         * other.x_coordinate + self.y_coordinate
                         * other.y_coordinate, 4)
        else:
    ...
    def rotate(self, degrees: int) -> "Vector":
        ...
        new_x = (self.x_coordinate * math.cos(radians)
                 - self.y_coordinate * math.sin(radians))
        new_y = (self.x_coordinate * math.sin(radians)
